...
declare namespace CodeMirror {
  ...
  function on(
    doc: Doc,
    eventName: "change",
    handler: (instance: Doc, changeObj: EditorChange) => void
  ): void;
  function off(
    doc: Doc,
    eventName: "change",
  ...
  interface Editor extends Doc {
    ...
    on(
      eventName: "inputRead",
      handler: (instance: CodeMirror.Editor, changeObj: EditorChange) => void
    ): void;
    off(
      eventName: "inputRead",
      handler: (instance: CodeMirror.Editor, changeObj: EditorChange) => void
    ...
    on(
      ...
      handler: (instance: CodeMirror.Editor, line: number) => void
    ): void;
    off(
      eventName: "electricInput",
      handler: (instance: CodeMirror.Editor, line: number) => void
    ...
    on(
      eventName: "swapDoc",
      handler: (instance: CodeMirror.Editor, oldDoc: CodeMirror.Doc) => void
    ): void;
    off(
      eventName: "swapDoc",
      handler: (instance: CodeMirror.Editor, oldDoc: CodeMirror.Doc) => void
    ...
    on(
      eventName: "focus",
      handler: (instance: CodeMirror.Editor, event: FocusEvent) => void
    ): void;
    off(
      eventName: "focus",
      handler: (instance: CodeMirror.Editor, event: FocusEvent) => void
    ...
    on(
      ...
      handler: (instance: CodeMirror.Editor, option: string) => void
    ): void;
    off(
      eventName: "optionChange",
      handler: (instance: CodeMirror.Editor, option: string) => void
  ...
  interface TextMarker {
    ...
    on(
      eventName: "clear",
      handler: (from: Position, to: Position) => void
    ): void;
   ...
   */
  interface Linter {
    (content: string, options: LintStateOptions, codeMirror: Editor):
      | Annotation[]
